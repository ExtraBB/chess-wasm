    ...
    public static class KingMoves 
    {
        ...
        private static IEnumerable<Move> GetCastlingMoves(Board board, Piece piece)
        {
            ...
            if(piece == Piece.WKing && !board.WKingMoved && board.WKing.NthBitSet((int)Square.E1))
            {
                ...
                if(emptyLeft && !board.WRookLeftMoved && !board.SquareIsInCheck(Square.C1, Player.White) && !board.SquareIsInCheck(Square.D1, Player.White) && !board.SquareIsInCheck(Square.E1, Player.White))
                {
            ...
            else if(piece == Piece.BKing && !board.BKingMoved && board.BKing.NthBitSet((int)Square.E8))
            {
                ...
                if(emptyLeft && !board.BRookLeftMoved && !board.SquareIsInCheck(Square.C8, Player.Black) && !board.SquareIsInCheck(Square.D8, Player.Black) && !board.SquareIsInCheck(Square.E8, Player.Black))
                {
